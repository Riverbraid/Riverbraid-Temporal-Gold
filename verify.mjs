...
const output = {
  ...
  version: "1.0.0",
  repo: "Riverbraid-Temporal-Gold",
  ring: 1,
  petal: "Temporal-Gold",
  invariant: "TEMPORAL_STATIONARY",
...
if (output.status !== "VERIFIED") {
  console.error("TEMPORAL_GOLD_VERIFICATION_FAILED");
  process.exit(1);
}
console.log("TEMPORAL_GOLD_VERIFICATION_SUCCESS");
